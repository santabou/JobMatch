...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.edutext = QTextBrowser(self.gridLayoutWidget)
        self.edutext.setObjectName(u"edutext")

        self.gridLayout.addWidget(self.edutext, 4, 1, 1, 5)

        self.eprtext = QTextBrowser(self.gridLayoutWidget)
        self.eprtext.setObjectName(u"eprtext")

        self.gridLayout.addWidget(self.eprtext, 5, 1, 1, 5)

        self.sktext = QTextBrowser(self.gridLayoutWidget)
        self.sktext.setObjectName(u"sktext")

        self.gridLayout.addWidget(self.sktext, 6, 1, 1, 5)
